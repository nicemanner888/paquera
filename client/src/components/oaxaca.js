			      ...
			      <Container>
		      		<Grid container spacing={6}>
		      			<Grid item xs={12} sm={6}>
				      		...
				      		<Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.storyText1}>
										The familes who plant the agave have known this land for centuries and take great care to ensure the fields are natural and grown organically. These Espadin agave take 6-7 years to mature.
				          </Typography>
		      			</Grid>
		      			<Grid item xs={12} sm={6}>
	      ...
	      <div className={classes.storyContent2}>
	      	<Container>
	      		<Grid container spacing={10}>
	      			<Grid item xs={12} sm={6} >
	      				<ScrollAnimation animateIn='fadeIn' duration={2} animateOnce="true">
		      				<Typography variant="h4" align="left" color="textPrimary" gutterBottom className={classes.storyHeader}>
				            Our Product
				          </Typography>
				      		<Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.storyText1}>
